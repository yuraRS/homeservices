(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new swiper_core_Swiper(".swiper", {
            ...
            navigation: {
                prevEl: ".here__arrow-l",
                nextEl: ".here__arrow-r"
            },
            on: {}
        });
    }
    ...
    document.addEventListener("click", burgerFunction);
    function burgerFunction(event) {
        if (event.target.closest(".icon-menu")) documentEl.classList.toggle("menu-open");
    }
